	...
	return &MoviesRepository{
		bd: map[int]models.Movie{
			1: {
				...
				WatchUrl:    "https://flcksbr.top/film/535341/",
			},
			2: {
				Id:          2,
				Title:       "Интерстеллар",
...
func (r *MoviesRepository) FindAll(context.Context) []models.Movie {
	movies := make([]models.Movie, 0, len(r.bd))
	for _, v := range r.bd {
